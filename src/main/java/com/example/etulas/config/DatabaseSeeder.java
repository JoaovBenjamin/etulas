        ...
        especialidadeRepository.saveAll(
                List.of(
                        Especialidades
                                .builder()
                                .id(1L)
                                .nome(EspecialidadesEnum.CARDIOLOGIA)
                                .descricaoEspecialidade(
                                        "Especialidade médica que se dedica ao diagnóstico e tratamento de doenças do coração e do sistema cardiovascular.")
                                .descricaoProcedimento(
                                        "Realização de consultas, exames de imagem, eletrocardiograma, ecocardiograma, entre outros.")
                                .ativo(true)
        ...
        equipamentosRepository.saveAll(
                List.of(
                        Equipamentos
                                ...
                                .procedimento(
                                        "Realização de exames de imagem detalhados para diagnóstico de diversas condições médicas.")
                                .sala(7)
                                .hospital(hospitalRepository.findById(1L).get())
                                .ativo(true)
                                .build()));
